...
const SharedBanner = ({ bannerHeading }) => {
  return (
    <div className="bg-indigo-50 h-[200px] md:h-[290px] md:flex justify-between ">
      <img className="h-48 mt-24 hidden md:block" src={bannerImg1} alt="" />
      <h2 className="pt-10 md:mt-12 text-4xl text-center font-bold">{bannerHeading}</h2>
