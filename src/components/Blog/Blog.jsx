  ...
  return (
    <div className="container space-y-10 my-10">
      <div className="space-y-4">
        <h2 className="fw-bold">1. When should you use context API?</h2>
        <span className="">
          <p className="fw-semibold">Answer: </p>
          We should use context API for some scenario that are given in below: <br />
          <span className=" fw-bolder">**</span> When multiple components need to access the same
          data: If you have multiple components that need to access the same data, using the Context
          API can help you avoid "prop drilling", which is the process of passing down data through
          multiple layers of components. <br />
          <span className="fw-bolder">**</span> When state needs to be shared across different parts
          of your application: If you have state that needs to be shared across different parts of
          your application, using the Context API can help you keep your code organized and reduce
          the amount of code you need to write. <br />
          <span className="fw-bolder">**</span> When you want to avoid using Redux: Redux is a
          popular state management library for React, but it can add unnecessary complexity to your
          application. If your state management needs are relatively simple, using the Context API
          may be a more lightweight and simpler solution.
        </span>
      </div>
      <div className="space-y-4">
        <h2 className="fw-bold">2. What is custom hook?</h2>
        <span className="">
          <p className="fw-semibold">Answer: </p>
      ...
      <div className="space-y-4">
        <h2 className="fw-bold">3. What useRef?</h2>
        <span className="">
          <p className="fw-semibold">Answer: </p>
      ...
      <div className="space-y-4 ">
        <h2 className="fw-bold">4. What is useMemo?</h2>
        <span className="">
          <p className="fw-semibold">Answer: </p>
